...
public class RSAUtils {
    public final static RSAUtils instance = new RSAUtils();

    /**
     * 生成公钥和私钥
     *
     */
    public HashMap<String, RSAKey> getKeys() throws NoSuchAlgorithmException{
        HashMap<String, RSAKey> map = new HashMap<>();
